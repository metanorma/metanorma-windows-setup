...
docker run -v ${pwd}:/metanorma/ ribose/metanorma metanorma -t unece -x html,xml,doc unece-cefact-recommendation-42.adoc
----


You may be prompted to share your current drive, such as "`C:\`", as shown below.
